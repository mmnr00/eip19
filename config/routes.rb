Rails.application.routes.draw do
  ...
  # 2. Redirect all other requests to '/holding_page'
  match '*path', 
        to: redirect('/penyelengaraan'), 
        via: :all, 
        constraints: lambda { |req| req.path != '/penyelengaraan' }

  # 3. Handle the root path as well
  root to: redirect('/penyelengaraan')
  ...
  # get '/btan_list', to: 'btans#btan_list'
  ...
  # #~~ILSC
  # get '/ilscindexapi', to: 'ilscs#ilscindexapi'
  ...
  # get '/vmadmin_ilsc', to: 'ilscs#vmadmin_ilsc'
  ...
  # get '/ddkxls', to: 'ddks#ddkxls'
  # get '/btnoku', to: 'ddks#btnoku'
  ...
  # #~~PROGE
  # get '/rptproge', to: 'proges#rptproge'
  ...
  # get '/progecert', to: 'proges#progecert'
  ...
  # #WELCOME#
  get '/penyelengaraan', to: 'welcomes#penyelengaraan'
  ...
  # get '/penyediaperkhidmatan', to: 'welcomes#penyediaperkhidmatan'
  # get '/rakananis443322', to: 'welcomes#rakananis'
  ...
  # get '/bantuanoku65765432', to: 'welcomes#bantuanoku2'
  # get '/bantuanOKU65765432', to: 'welcomes#bantuanoku'
  # #get '/intervensianis', to: 'welcomes#intervensianis'
  # get '/daftarsaringan', to: 'welcomes#daftarsaringan'
  ...
  # get '/brais', to: 'welcomes#bantuananis', as: 'bantuananis'
